...
var myFavSuperheroes = ['superman', 'batman', 'ironman', 'hulk', 'dr.strange'];
...
// Challenge 9: Add your friend's name (friend 1) to the array "myFavSuperheroes" at the 3rd positioncnwithout removing any element using the splice method.

myFavSuperheroes.splice(3, 0, 'sarvesh');
console.log(myFavSuperheroes);
...
myFavSuperheroes.splice(4, 2, 'nivaash');
console.log(myFavSuperheroes);
...
superherodc = ['flash', 'joker', 'aquaman'];
superheroUniverse = [];
superheroUniverse.push(myFavSuperheroes);
superheroUniverse.push(superherodc);
